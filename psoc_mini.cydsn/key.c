...
//            move.ks_tmp=THREAD_MM_STEP_I(Thread[0]);
//            move.ks_inc=mode.Thread<1?1:(move.ks_tmp-move.ks_div)/mode.Thread;//
            break;
        case Mode_Tpi:
...
//            move.ks_inc=mode.Feed<1?1:(move.ks_tmp-move.ks_div)/mode.Feed;//
    ...
    move.ks_tmp=FEED_MM_STEP(Feeds[0]);
    move.ks_acc=move.ks_tmp;
    move.ks_inc=(move.ks_tmp-move.ks_div)/20;//
    if(move.ks_inc<1)move.ks_tmp=1;
//    move.ks_tmp=move.ks_acc=move.ks_div+ACCEL;
